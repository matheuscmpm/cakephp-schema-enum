...
class CakeSchema extends Object {
    ...
    protected function _columns(&$Obj) {
        ...
        foreach ($fields as $name => $value) {
            ...
            /**
             * Also added to be able to handle ENUM type fields
             * @author matheuscmpm
             */
            $isEnum = (strpos($value['type'], 'enum') !== false);

            /**
             * Second condition added to be able to handle enum's
             *@author matheuscmpm
             */
            if (!isset($db->columns[$value['type']]) && !$isEnum) {
                ...
                /**
                 * Added lines 628~635 to be able to handle ENUM type fields
                 * @author matheuscmpm
                 */
                if($isEnum){
                    //TODO: replace for regex to be prettier
